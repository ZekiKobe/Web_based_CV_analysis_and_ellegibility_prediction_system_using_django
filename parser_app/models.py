...
class contactComment(models.Model):
    ...
    comment=models.TextField('Comment', max_length=65535,null=True,blank=True)

class recruiters(models.Model):
     FullName=models.CharField('Full Name',max_length=100,blank=True)
     recruiter_email=models.CharField('Email',max_length=255,null=True,blank=True)
     username=models.CharField('Username',max_length=100,null=True,blank=True)
     recruiter_password=models.CharField('Password',max_length=20,null=True,blank=True)
     recruiter_confirm_password=models.CharField('Confirm Password',max_length=20,null=True,blank=True)
